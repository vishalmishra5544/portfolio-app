...
export class HomeComponent implements AfterViewInit {
  ...
  timelineData = [
    ...
    { date: '2024-08-01', title: '08/2024-06/2025: Associate Software Engineer-AI at TSS Consultancy', description: 'Entered AI domain to fulfill organization need for AI-based APIs and developed computer vision APIs with YOLO and Flask alongside Java Backend systems.', img: 'tsslogo.jpg' },
    { date: '2025-06-01', title: '06/2025-Present: Software Engineer-AI at TSS Consultancy', description: 'Developing AI based Onboarding Solutions with various integrations.', img: 'tsslogo.jpg' },
  ];
